...
const Login = ({handleLogin}) => {
    ...
    return(
       ...
       <div class="container-fluid">
                           ...
                           <div class="row">
                               <div class="col-lg-10 col-xl-7 mx-auto">
                                   ...
                                   <Form onSubmit={onSubmitHandler} method="POST">
                                       ...
                                       <button type="submit" class="btn btn-primary text-uppercase mb-2 rounded-pill shadow-sm w-100">Sign in</button>
                                       </div>
                                   </Form>
                               </div>
                           </div>
        ...
        //             <Form.Control type="text" name="email" value={user.email} onChange={onChangeHandler}></Form.Control>
        //         </Form.Group>
        //         <Form.Group>
        //             <Form.Label>Password</Form.Label>
        //             <Form.Control type="password" name="password" value={user.password} onChange={onChangeHandler}></Form.Control>
        //         </Form.Group>
